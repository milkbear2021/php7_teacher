<?php 
require_once("connMysql.php");//載入MysqliObj連線檔案
//預設每頁筆數
$pageRow_records = 5;//設定每頁顯示5筆資料
//預設目前所在頁數
$num_pages = 1;//一開始設定在第一頁
//若已經有翻頁，將頁數更新
if (isset($_GET['page'])) {//如果從URL列有傳來參數page則執行下列程式
  $num_pages = $_GET['page'];//將從URL參數所得的值指定到$num_pages(目前所在頁數)
}
                        ...
                        <tr valign="top">
                            ...
                            <td class="underline">
                                ...
                                <p align="right" class="smalltext">
                                    ...
                                    <a href="mailto:<?php echo $row_RecBoard["boardmail"];?>"><img
                                            src="images/email-a.png" alt="電子郵件" width="16" height="16" border="0"
                                            align="absmiddle"></a>
                                    <?php }?>
                                    <?php if($row_RecBoard["boardweb"]!=""){?>
                                    <a href="<?php echo $row_RecBoard["boardweb"];?>"><img src="images/home-a.png"
                                            alt="個人網站" width="16" height="16" border="0" align="absmiddle"></a>
                                    <?php }?>
                                </p>
                            </td>
                        </tr>
